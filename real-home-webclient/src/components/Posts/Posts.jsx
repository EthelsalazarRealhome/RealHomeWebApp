    ...
    <ul className="mx-[50px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8 mt-4">
      {
                  ...
                  <div className="flex mb-2">
                    <div className="w-[50%] pr-2">
                      ...
                      <div className="text-lg font-bold text-green-500 mb-2">
                        Precio: ${post.price}{(post.service === "alquiler") ? "/mensuales" : null} {post.neg_price ? <p className="text-green-500 font-bold">Negociables</p> : null}
                      </div>
                    </div>
        ...
        :
          <section>
            <p>No se encontraron propiedades con los parámetros dados</p>
          </section>
      }
    </ul>
  );
