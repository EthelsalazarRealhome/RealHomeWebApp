        ...
        <div className="min-h-[800px] flex flex-col w-full">
          ...
          <div className="flex justify-center items-center">
            <div className="max-w-2xl mx-4 text-left">
              ...
              <p className="mb-6">
                1. Venta o Alquiler de tu Propiedad: Te ofrecemos asesoramiento experto y una estrategia personalizada para la venta o alquiler de tu propiedad, asegurando un proceso eficiente y efectivo desde el inicio hasta el cierre.
              </p>
              <p className="mb-6">
                2. Venta o Alquiler de Propiedades del Catálogo: Contamos con un variado catálogo de propiedades cuidadosamente seleccionadas para la venta o alquiler. Cada opción ha sido evaluada minuciosamente para asegurar la calidad de oportunidades inmobiliarias.
              </p>
              <p className="mb-0">
