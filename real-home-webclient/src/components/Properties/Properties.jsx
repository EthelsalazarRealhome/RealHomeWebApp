  ...
  return (
    <section>
      <div className="max-w-7xl lg:mx-10 mx-0 md:mx-6 sm:mx-2 mt-5 p-4">
        <h2 className="lg:text-5xl text-2xl px-0 font-bold mb-6 sm:mb-3 mt-[70px]">
      ...
      {
          loading ? <p className="text-center h-screen mt-8 text-4xl lg:text-8xl py-16 mb-11">Cargando propiedades...</p> : <Posts posts={filteredPosts} />
      }
